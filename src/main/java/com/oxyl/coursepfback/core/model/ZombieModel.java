...
/**
 * Classe modèle représentant un zombie dans le jeu.
 * Contient toutes les caractéristiques d'un zombie comme ses points de vie,
 * son attaque, sa vitesse de déplacement, etc.
 */
public class ZombieModel {
     ...
     */
    public ZombieModel(Integer id_zombie, String nom, Integer point_de_vie, Double attaque_par_seconde,
